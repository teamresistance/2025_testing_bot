...
package frc.robot.subsystems.drive.support.module;
...
public class ModuleIOSpark implements ModuleIO {
  ...
  public ModuleIOSpark(int module) {
    ...
    cancoder =
        new CANcoder(
            switch (module) {
              case 0 -> Constants.CANCODER_FL;
              case 1 -> Constants.CANCODER_FR;
              case 2 -> Constants.CANCODER_BL;
              case 3 -> Constants.CANCODER_BR;
              default -> 0;
            });
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(odometryFrequency, turnAbsolutePosition);
